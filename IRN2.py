...
resultBRN1 = []
resultBRN2 = []
resultBRN1.append(BRN1)
resultBRN2.append(BRN2)
x1list = []
x2list = []
tlist = []
x3list = []
...
while i < 100:
    i += 1
    beta_h2 = 0.8229999999999239+(00.8229999999999239*i*.05)
...
plt.plot(resultBRN1,resultBRN2)
