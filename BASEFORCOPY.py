...
def beta_h2_func(beta_h2):
    return ch*(beta_h2 + rho2*H)-1
...
solbetah1 = root(beta_h_func, 1)
beta_h1 = solbetah1.x[0]

solbetah2 = root(beta_h2_func, 1)
beta_h2 = solbetah2.x[0]
